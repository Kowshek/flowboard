  ...
  return (
    <div className="space-y-5">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <a href="#" className="text-xs text-violet-600 dark:text-violet-400 hover:text-violet-700 font-medium">
              Forgot password?
            </a>
          </div>
          <input
      ...
      <button
        ...
        className="w-full h-11 flex items-center justify-center gap-3 rounded-lg border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-white/10 transition-colors shadow-sm dark:shadow-none"
      >
      ...
      <p className="text-center text-sm text-gray-500 dark:text-gray-400">
        ...
        <Link href="/signup" className="text-violet-600 dark:text-violet-400 hover:text-violet-700 font-semibold">
          Sign up free
        </Link>
      </p>
    </div>
